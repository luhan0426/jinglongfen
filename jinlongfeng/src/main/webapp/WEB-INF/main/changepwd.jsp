...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/common/css/css.css" />
...
<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="<%=request.getContextPath() %>/common/img/coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;<a
			...
			<div class="bacen">
				...
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;输入旧密码：
					   ...
					   <img class="imga" src="<%=request.getContextPath() %>/common/img/ok.png" />
					   <img class="imgb" src="<%=request.getContextPath() %>/common/img/no.png" />
				</div>
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;输入新密码：
					<input type="password" class="input3" onblur="checkpwd2()" id="pwd2" /> 
					<img class="imga" src="<%=request.getContextPath() %>/img/ok.png" />
					<img class="imgb" src="<%=request.getContextPath() %>/img/no.png" />
				</div>
				<div class="bbD">
